...
# use two signals (for top and bottom rows) to maintain pin#
#====================================================================================================
set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports {jstk_cs}]
set_property -dict {PACKAGE_PIN F16 IOSTANDARD LVCMOS33} [get_ports {jstk_mosi}]
set_property -dict {PACKAGE_PIN G16 IOSTANDARD LVCMOS33} [get_ports {jstk_miso}]
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33} [get_ports {jstk_sclk}]
...
# use two signals (for top and bottom rows) to maintain pin#
#====================================================================================================
set_property -dict {PACKAGE_PIN H4 IOSTANDARD LVCMOS33} [get_ports {pmod_jd_ctrl[0]}] 
set_property -dict {PACKAGE_PIN H1 IOSTANDARD LVCMOS33} [get_ports {pmod_jd_ctrl[1]}] 
set_property -dict {PACKAGE_PIN G1 IOSTANDARD LVCMOS33} [get_ports {pmod_jd_ctrl[2]}] 
set_property -dict {PACKAGE_PIN G3 IOSTANDARD LVCMOS33} [get_ports {pmod_jd_ctrl[3]}] 
set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS33} [get_ports {pmod_jd_ctrl[4]}] 
set_property -dict {PACKAGE_PIN G4 IOSTANDARD LVCMOS33} [get_ports {pmod_jd_ctrl[5]}] 
set_property -dict {PACKAGE_PIN G2 IOSTANDARD LVCMOS33} [get_ports {pmod_jd_ctrl[6]}] 
set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports {pmod_jd_ctrl[7]}]
